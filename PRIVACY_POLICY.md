# Privacy Policy for the paperlesser Browser Extension

Last updated: 16.01.2025

## 1. General Information

The paperlesser Browser Extension ("the Extension") is a browser extension designed to connect your Paperless-ngx instance with your paperlesser server. We are committed to protecting your privacy and personal data.
...
- URL of your paperlesser server
- API key for the paperlesser service
...
- Document contents are transmitted exclusively to your configured paperlesser server
...
- Your self-configured paperlesser server
...
- "host_permissions": For communication with your Paperless-ngx and paperlesser servers
...
- Processing occurs on your configured paperlesser server
